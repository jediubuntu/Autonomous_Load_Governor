...
def get_api_key() -> str:
    ...
    if not api_key:
        raise RuntimeError(
            "Missing API key. Set ALG_LLM_API_KEY, GEMINI_API_KEY, GOOGLE_API_KEY, or OPENAI_API_KEY in .env."
        )
    return api_key


def get_base_url() -> str:
    return os.getenv("ALG_LLM_BASE_URL", "https://generativelanguage.googleapis.com/v1beta/openai").rstrip("/")
